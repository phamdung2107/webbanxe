      ...
      <div className="about__page">
        ...
        <div className="row flex">
          <div className="col__2">
            <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/page/about-1.png" />
          </div>
          <div className="col__2">
            <div className="meta">
              <span
        ...
        <div className="second">
          ...
          <div className="row flex">
            <div className="col__3">
              ...
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-1.svg" />
                </div>
            ...
            <div className="col__3">
                ...
                <div className="flex align__items__center justify__content__center image">
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-2.svg" />
                </div>
            ...
            <div className="col__3">
                ...
                <div className="flex align__items__center justify__content__center image">
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-3.svg" />
                </div>
            ...
            <div className="col__3">
                ...
                <div className="flex align__items__center justify__content__center image">
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-4.svg" />
                </div>
            ...
            <div className="col__3">
                ...
                <div className="flex align__items__center justify__content__center image">
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-5.svg" />
                </div>
            ...
            <div className="col__3">
                ...
                <div className="flex align__items__center justify__content__center image">
              <img alt="" src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/icons/icon-6.svg" />
                </div>
